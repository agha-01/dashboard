                      ...
                      <div class="card-body card-block">
                        <form action="newsadd" method="post" enctype="multipart/form-data" class="form-horizontal">
                          ...
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">email unvan</label></div>
                            <div class="col-12 col-md-9">

                              <input type="text" id="text-input" name="basliq" placeholder="email.." class="form-control">

                              <small class="form-text text-muted">email unvan</small></div>
                          </div>
